...
try {
   ...
   String cuentaInicial=account;
	...
	//Obtenemos datos de la validación a través de la VPN de invex, invocando un Servicio Web
...
//		e.printStackTrace();
//		throw new WSSeguridadException(
//				"5|No esta respondiendo el Servicio, servicio de validación de la VPN por usuario");
//	}
//	if (doc == null) {
//		throw new WSSeguridadException(
//				"5|No esta respondiendo el Servicio, servicio de validación de la VPN por usuario");
