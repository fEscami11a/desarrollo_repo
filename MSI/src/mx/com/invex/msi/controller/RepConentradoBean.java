...
@ManagedBean(name="repConcentrado")
@SessionScoped
public class RepConentradoBean extends MessagesMBean implements Serializable{
 
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(RepConentradoBean.class);
...
//	}
	 ...
	 public void init(List<RepConcentradoDTO> compras,Date fechaIn,Date fechaFin) throws JRException{  
	...
	String  reportPath=  FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reports/ReportePortalPU.jasper");        
	...
	jasperPrint=JasperFillManager.fillReport(reportPath, params,beanCollectionDataSource);  
	 ...
	 public void XLSX(List<RepConcentradoDTO> lcomp,Date fechaIn,Date fechaFin) throws JRException, IOException{  
	     logger.info("XLSLS");   
		 try {
