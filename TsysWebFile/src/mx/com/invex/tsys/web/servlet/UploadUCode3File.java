...
@WebServlet("/UploadUcode3File")
@ServletSecurity(
@HttpConstraint(
    rolesAllowed = {"USR_TSYS"}))
public class UploadUCode3File extends HttpServlet{
	private static final Logger log = Logger.getLogger(UploadUCode3File.class);
