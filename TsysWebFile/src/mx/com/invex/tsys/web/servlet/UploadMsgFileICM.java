...
@WebServlet("/UploadMsgFileICM")
@ServletSecurity(
@HttpConstraint(
    rolesAllowed = {"USR_TSYS"}))
public class UploadMsgFileICM extends HttpServlet{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(UploadMsgFileICM.class);
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.info(" UploadMsgFileICM");
				                	   ...
				                	   if(linea!= null){
				                		StringTokenizer tokens=new StringTokenizer(linea, "|");
						     			...
						     			if(!m.matches()){
						                  ...
						                  String msgText= datos[1];
						                  NCM ncm = new NCMImpl();
						                  String msgType = "01";
						     			 String collNum = "999999";
						     			 String actionCode = "CS";
						     		
						                  ncm.addCollectionMessage(cuenta, request.getRemoteUser(), null, null, collNum, msgType, actionCode, msgText);
