...
@WebServlet("/UploadExpDateFile")
@ServletSecurity(
@HttpConstraint(
    rolesAllowed = {"USR_TSYS"}))
public class UploadExpDateFile extends HttpServlet{
	private static final Logger log = Logger.getLogger(UploadExpDateFile.class);
