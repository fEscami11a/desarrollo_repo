 ...
 * 
 */
public class ConnectionFactoryPLealtad {

	private static Logger log = Logger.getLogger(ConnectionFactoryPLealtad.class);
	private final static String LOADER = "oracle.jdbc.driver.OracleDriver";

	private final static String DATASOURCE = "jboss/datasources/uvolaris";
