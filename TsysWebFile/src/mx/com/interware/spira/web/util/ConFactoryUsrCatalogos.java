 ...
 * 
 */
public class ConFactoryUsrCatalogos {

	private static Logger log = Logger.getLogger(ConFactoryUsrCatalogos.class);
	private final static String LOADER = "oracle.jdbc.driver.OracleDriver";


	private final static String DATASOURCE = "jdbc/catalogos";
